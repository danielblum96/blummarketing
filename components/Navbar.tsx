...
export default function Navbar({ basePath = "" }: NavbarProps) {
  ...
  const links = [
    { href: `${basePath}/#szolgaltatasok`, label: "Szolgáltatások" },
    { href: `${basePath}/#ajanlat`, label: "Csomag" },
    { href: `${basePath}/#folyamat`, label: "Folyamat" },
    ...
    <header className="relative z-50">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-8 text-sm text-neutral-300 md:flex" aria-label="Fő navigáció">
          ...
          <a href={`${basePath}/#kapcsolat`} className="rounded-full bg-white px-5 py-2.5 font-semibold text-neutral-950 transition hover:bg-neutral-200">
            Ajánlatkérés
          </a>
        </nav>
      ...
      {open && (
        <nav
          className="absolute inset-x-0 top-full mx-4 rounded-2xl border border-white/10 bg-neutral-900 p-5 shadow-2xl md:hidden"
