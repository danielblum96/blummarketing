...
export const metadata = {
  title: "Fotó- és videókészítés | Blummarketing",
  description: "Professzionális fotó- és videóanyagok készítése hirdetésekhez és social media tartalmakhoz.",
  openGraph: {
    title: "Fotó- és videókészítés | Blummarketing",
    description: "Professzionális fotó- és videóanyagok készítése hirdetésekhez és social media tartalmakhoz.",
    type: "website",
    ...
    <main className="min-h-screen bg-neutral-950 text-white antialiased">
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 pt-14 lg:px-8">
          ...
          <h1 className="mt-4 text-3xl font-black tracking-tight sm:text-4xl lg:text-5xl">Fotó- és videókészítés</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-300">Professzionális fotó- és videóanyagok készítése hirdetésekhez és social media tartalmakhoz.</p>
