    ...
    <main className="min-h-screen bg-neutral-950 text-white antialiased">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-6 pb-16 pt-14 lg:px-8">
          <a href="/tudastar/meta-hirdetesek/" className="mb-6 inline-flex items-center gap-2 text-sm text-neutral-400 hover:text-white transition">
            ← Vissza: Meta hirdetések
          </a>
