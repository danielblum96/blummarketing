...
export const metadata = {
  title: "Fogalomtár | Tudástár | Blummarketing",
  description: "PPC, Meta, TikTok és digitális marketing fogalmak érthetően magyarázva.",
  openGraph: {
    title: "Fogalomtár | Tudástár | Blummarketing",
    description: "PPC, Meta, TikTok és digitális marketing fogalmak érthetően magyarázva.",
    type: "website",
    ...
    <main className="min-h-screen bg-neutral-950 text-white antialiased">
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 pt-14 lg:px-8">
          ...
          <h1 className="mt-4 text-5xl font-black tracking-tight sm:text-6xl">Fogalomtár</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-300">PPC, Meta, TikTok és digitális marketing fogalmak érthetően magyarázva.</p>
        </div>
      </section>
