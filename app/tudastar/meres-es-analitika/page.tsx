...
export const metadata = {
  title: "Mérés és analitika | Tudástár | Blummarketing",
  description: "GA4, Google Tag Manager, pixel-mérés és konverziókövetés útmutatók.",
  openGraph: {
    title: "Mérés és analitika | Tudástár | Blummarketing",
    description: "GA4, Google Tag Manager, pixel-mérés és konverziókövetés útmutatók.",
    type: "website",
    ...
    <main className="min-h-screen bg-neutral-950 text-white antialiased">
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 pt-14 lg:px-8">
          ...
          <h1 className="mt-4 text-5xl font-black tracking-tight sm:text-6xl">Mérés és analitika</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-300">GA4, Google Tag Manager, pixel-mérés és konverziókövetés útmutatók.</p>
        </div>
      </section>
