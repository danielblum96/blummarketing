...
export const metadata = {
  title: "Kreatívok és videós tartalom | Tudástár | Blummarketing",
  description: "TikTok és Meta kreatívstratégia, videóformátumok és UGC útmutatók.",
  openGraph: {
    title: "Kreatívok és videós tartalom | Tudástár | Blummarketing",
    description: "TikTok és Meta kreatívstratégia, videóformátumok és UGC útmutatók.",
    type: "website",
    ...
    <main className="min-h-screen bg-neutral-950 text-white antialiased">
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 pt-14 lg:px-8">
          ...
          <h1 className="mt-4 text-5xl font-black tracking-tight sm:text-6xl">Kreatívok és videós tartalom</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-300">TikTok és Meta kreatívstratégia, videóformátumok és UGC útmutatók.</p>
        </div>
      </section>
